    ...
    <footer className="bg-muted py-16">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-serif font-bold text-primary">GiftElite</span>
            </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:hello@giftelite.com" className="text-muted-foreground hover:text-primary transition-colors">
                  hello@giftelite.com
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-border mt-12 pt-8 text-center text-muted-foreground">
          <p>&copy; {currentYear} GiftElite. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
